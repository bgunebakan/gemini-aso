...
if __name__ == "__main__":
    ...
    try:
        ...
        current_market = input_data.get("current_market", "us")
        budget = input_data.get("budget_level", "medium")
        downloads = input_data.get("monthly_downloads", 1000)

        results = plan_localization_strategy(current_market, budget, downloads)
