...
if __name__ == "__main__":
    ...
    try:
        ...
        test_type = input_data.get("test_type", "title")
        variant_a = input_data.get("variant_a", {})
        variant_b = input_data.get("variant_b", {})
        hypothesis = input_data.get("hypothesis", "")
        baseline_cvr = input_data.get("baseline_conversion", 0.05)

        results = plan_ab_test(
            test_type, variant_a, variant_b, hypothesis, baseline_cvr
        )
